...
<body>
    ...
    <div class="container mt-4">
        ...
        if ($conn->query($sql) === TRUE) {
            echo "<p class='text-success'>Producto eliminado con éxito</p>";
        } else {
            echo "<p class='text-danger'>Error al eliminar el producto: " . $conn->error . "</p>";
        }

        $conn->close();
        ?>
        <a href="formProducto.html" class="btn btn-secondary mt-3">Regresar al Formulario de Productos</a>
    </div>
