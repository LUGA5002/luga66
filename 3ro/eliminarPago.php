    ...
    <div class="container mt-4">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if ($conn->query($sql) === TRUE) {
                echo "<p class='text-success'>Pago eliminado con éxito</p>";
            } else {
                echo "<p class='text-danger'>Error al eliminar el pago: " . $conn->error . "</p>";
            }
        }

        $conn->close();
        ?>
        <a href="formPago.html" class="btn btn-secondary mt-3">Regresar al Formulario de Pagos</a>
    </div>
